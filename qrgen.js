...
function show_in_div(str,path) { console.log(UTF8ToString(path)); document.getElementById(UTF8ToString(path)).innerHTML = UTF8ToString(str); }
function log_critical_impl(str) { console.log(str); alert(UTF8ToString(str)); }
function log_progress_ver_lv_impl(ver,lv) { const levels = ['L','M','Q','H']; document.getElementById("ver_lv_progress").value = 4 * ver + lv; document.getElementById("ver_lv_label").textContent = 'Trying Version ' + ver + ',Level ' + levels[lv]; }
function log_progress_equations_impl(equations,total) { document.getElementById("equations_progress").value = equations; document.getElementById("equations_progress").max = total; document.getElementById("equations_label").textContent = "" + equations + '/' + total; }
...
var wasmImports = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "log_critical_impl": log_critical_impl,
  "log_progress_equations_impl": log_progress_equations_impl,
  "log_progress_ver_lv_impl": log_progress_ver_lv_impl,
  "show_in_div": show_in_div,
...
/** @type {function(...*):?} */
var _do_search = Module["_do_search"] = createExportWrapper("do_search");
/** @type {function(...*):?} */
...
var ___start_em_js = Module['___start_em_js'] = 84764;
var ___stop_em_js = Module['___stop_em_js'] = 85457;
